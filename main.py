...
task_type_combo = ttk.Combobox(gen_frame, textvariable=task_type_var, values=["Учёба", "Спорт", "Работа", "Дом", "Другое"], width=15)
task_type_combo.grid(row=0, column=1, padx=5)

tk.Button(gen_frame, text="Сгенерировать задачу", command=generate_task, bg="green", fg="white").grid(row=1, column=0, columnspan=2, pady=10)
...
filter_combo = ttk.Combobox(filter_frame, textvariable=filter_type_var, values=["Все", "Учёба", "Спорт", "Работа", "Дом", "Другое"], width=15)
